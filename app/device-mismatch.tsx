import { DeviceMismatchScreen } from "@/features/device-mode";
 ...
 * `DeviceMismatchScreen` is the normal case, not an exception.
 *
 ...
 * screen as props.
 */
export default function DeviceMismatchRoute() {
  return <DeviceMismatchScreen />;
}
