...
| FR-2 | minor                       | the double-storage-failure branches carried a latent, misleading memoryOnly downgrade call (it could never fire with clearFailed standing — discardRecord sets it first — but it was the wrong pattern to keep)                                | fixed — persistence deliberately untouched (RT03-7 reasoning), honest log instead                                                                                                                                                                                                                                                                                                                    |
