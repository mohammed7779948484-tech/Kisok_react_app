...
Load the **`kisok-quality-audit`** skill and follow it.

## Your sources

`docs/brief.md`, `docs/plan.md`, `docs/todo.md`, `docs/worklog.md`,
`docs/review.md`, the actual `git diff`, and the commands that were really run.
Findings live in the gaps between them.
